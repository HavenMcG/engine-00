...
class Renderer {
public:
	void draw_models(glm::mat4 view_matrix, Shader& shader, ModelCollection& models, TransformCollection& transforms, DirectionalLightCollection& directional_lights, PointLightCollection& lights, const OglAssetStore& assets);
